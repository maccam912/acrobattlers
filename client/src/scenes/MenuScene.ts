...
export default class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        const startButton = this.add.text(100, 200, 'Start Game', { fontSize: '24px', fill: '#0f0' })
            .setInteractive()
            .on('pointerdown', () => this.startGame());

        const instructionsButton = this.add.text(100, 250, 'Instructions', { fontSize: '24px', fill: '#0f0' })
            .setInteractive()
